...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/steep-field-518b)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/steep-field-518b#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/steep-field-518b
```

A live public deployment of this template is available at [https://steep-field-518b.templates.workers.dev](https://steep-field-518b.templates.workers.dev)
